...
'deny_duplicate_data_instructions' => 'Useful for keeping spammers and other nonsense at bay. This setting ensures there\'s no data being submitted that exactly matches another. <a href="?D=cp&C=admin_system&M=security_session_preferences">Change</a>',
...
'allow_username_change_instructions' => 'It\'s not a very good idea to allow your users to change their username because then accountability becomes tough and misleading when it comes to user activity. <a href="?D=cp&C=admin_system&M=security_session_preferences">Change</a>',
'allow_multi_logins' => 'Allow Multiple Logins?',
'allow_multi_logins_instructions' => 'This setting makes it easy for attackers to spoof attacks on your system. Setting it to No is recommended. <a href="?D=cp&C=admin_system&M=security_session_preferences">Change</a>',
'require_ip_for_login' => 'Require IP and User Agent For Login?',
'require_ip_for_login_instructions' => 'This setting requires that all requests to your ExpressionEngine site provide a valid IP address and User Agent. <a href="?D=cp&C=admin_system&M=security_session_preferences">Change</a>',
'require_ip_for_posting' => 'Require IP and User Agent For Posting?',
'require_ip_for_posting_instructions' => 'Just like the sister setting for logging in, this setting requires there be a valid IP address and User Agent sent when posting comments. <a href="?D=cp&C=admin_system&M=security_session_preferences">Change</a>',
'xss_clean_uploads' => 'XSS Clean Uploads?',
'xss_clean_uploads_instructions' => 'Enabling this setting will have ExpressionEngine parse uploaded files looking for anything malicous or evil. <a href="?D=cp&C=admin_system&M=security_session_preferences">Change</a>',
'password_lockout' => 'Password Lockout?',
'password_lockout_instructions' => 'This setting makes it so if a user doesn\'t login successfully after attempting 4 times they are locked out for a TBD amount of time. <a href="?D=cp&C=admin_system&M=security_session_preferences">Change</a>',
'password_lockout_interval' => 'Password Lockout Interval?',
'password_lockout_interval_instructions' => 'The Password Lockout Interval is the amount of time to require users to wait once their account has been locked. Setting this to more than 15 is recommended. <a href="?D=cp&C=admin_system&M=security_session_preferences">Change</a>',
'require_secure_passwords' => 'Require Secure Password?',
'require_secure_passwords_instructions' => 'Enabling this is just a good idea for every site. It requires every password created be made of at least 1 lowercase letter, 1 uppercase letter and 1 number. <a href="?D=cp&C=admin_system&M=security_session_preferences">Change</a>',
'allow_dictionary_pw' => 'Allow Dictionary Password?',
'allow_dictionary_pw_instructions' => 'Setting this to No will prevent users from choosing passwords that are easily hacked using what are called <a href="http://en.wikipedia.org/wiki/Dictionary_attack">Dictionary Attacks</a>. If Secure Passwords are required this setting is essentially moot. <a href="?D=cp&C=admin_system&M=security_session_preferences">Change</a>',
'pw_min_len'  => 'Minimum Password Length?',
'pw_min_len_instructions' => 'The more characters in a password the more secure it is; a minimum of 8 characters is recommended. <a href="?D=cp&C=admin_system&M=security_session_preferences">Change</a>',
'enable_throttling' => 'Enable Throttling?',
'enable_throttling_instructions' => 'Enabling the throttling controls is an extremely easy way to help protect your site from automated scripts and attacks. <a href="?D=cp&C=admin_system&M=throttling_configuration">Change</a>',
'max_page_loads' => 'Max Page Loads?',
'max_page_loads_instructions' => 'Used in conjunction with Time Interval this setting sets how many requests a user can have for any ExpressionEngine page. It\'s recommended that this setting be at least 20. <a href="?D=cp&C=admin_system&M=throttling_configuration">Change</a>',
'time_interval' => 'Time Interval?',
'time_interval_instructions' => 'The amount of time, in seconds, that the throttling checks are applied. It\'s recommended that this setting be set to at least 5. <a href="?D=cp&C=admin_system&M=throttling_configuration">Change</a>',
'lockout_time' => 'Lockout Time?',
'lockout_time_instructions' => 'How long should the lockout last when it\'s activated? Ideally, this should be set to more than 1800 seconds. <a href="?D=cp&C=admin_system&M=throttling_configuration">Change</a>',
'debug' => 'Debug?',
'debug_instructions' => 'Unless your site is under development the Debug settings should be turned off. <a href="?D=cp&C=admin_system&M=output_debugging_preferences">Change</a>',
'profile_trigger' => 'Profile Trigger',
'profile_trigger_instructions' => 'If you leave this in the defaul of "member", visitors to your site can access member lists and possibly reveal details about your members. <a href="?D=cp&C=members&M=member_config">Change</a>',
'admin_session_type' => 'Admin Session Type',
'admin_session_type_instructions' => 'This setting tells ExpressionEngine how it should authenticate users who visit the CP. For extra security it\'s recommended that you require both Cookie and Session. <a href="?D=cp&C=admin_system&M=security_session_preferences">Change</a>',
...
'enable_cp_reg_email_on_activate_instructions' => 'Should the email be sent on <a href="?S=0&D=cp&C=members&M=member_validation">Activate Pending</a> module from within the Control Panel? If checked, Securit:ee will send the email to all members when activated. Uses the CP Registration email.',
''=>''
);